/**
 * bootstrap-formhelpers.js v2.0.0 by
 * 
 * @vincentlamanna Copyright 2013 Vincent Lamanna
...
var BFHMonthsList = [ 'January', 'February', 'March', 'April', 'May', 'June',
 ...
 * https://github.com/vlamanna/BootstrapFormHelpers
 * ========================================================== Copyright 2012
 * Vincent Lamanna contributed by Aaron Collegeman, Squidoo, 2012
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 * use this file except in compliance with the License. You may obtain a copy of
 * the License at
...
var BFHGoogleFontsList = {
	...
	'items' : [
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Advent Pro',
				'variants' : [ '100', '200', '300', 'regular', '500', '600',
						'700' ],
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Alegreya',
				'variants' : [ 'regular', 'italic', '700', '700italic', '900',
						'900italic' ],
				'subsets' : [ 'latin-ext', 'latin' ]
			},
			{
			...
			},
			{
				...
				'variants' : [ 'regular', 'italic', '700', '700italic' ],
				'subsets' : [ 'cyrillic', 'greek-ext', 'latin-ext', 'latin',
						'greek', 'cyrillic-ext' ]
			},
			{
				'kind' : 'webfonts#webfont',
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Averia Libre',
				'variants' : [ '300', '300italic', 'regular', 'italic', '700',
						'700italic' ],
				'subsets' : [ 'latin' ]
			},
			{
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Cabin',
				'variants' : [ 'regular', 'italic', '500', '500italic', '600',
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Crimson Text',
				'variants' : [ 'regular', 'italic', '600', '600italic', '700',
						'700italic' ],
				'subsets' : [ 'latin' ]
			},
			{
			...
			},
			{
				...
				'family' : 'EB Garamond',
				'variants' : [ 'regular' ],
				'subsets' : [ 'cyrillic', 'latin-ext', 'latin', 'vietnamese',
						'cyrillic-ext' ]
			},
			{
				'kind' : 'webfonts#webfont',
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Exo',
				'variants' : [ '100', '100italic', '200', '200italic', '300',
						'300italic', 'regular', 'italic', '500', '500italic',
						'600', '600italic', '700', '700italic', '800',
			...
			},
			{
				...
				'variants' : [ '100', '100italic', '300', '300italic',
						'regular', 'italic', '600', '600italic', '700',
						'700italic' ],
				'subsets' : [ 'latin' ]
			},
			{
			...
			},
			{
				...
				'family' : 'Lato',
				'variants' : [ '100', '100italic', '300', '300italic',
						'regular', 'italic', '700', '700italic', '900',
						'900italic' ],
				'subsets' : [ 'latin' ]
			},
			{
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Open Sans',
				'variants' : [ '300', '300italic', 'regular', 'italic', '600',
						'600italic', '700', '700italic', '800', '800italic' ],
				'subsets' : [ 'cyrillic', 'greek-ext', 'latin-ext', 'latin',
						'vietnamese', 'greek', 'cyrillic-ext' ]
			},
			{
				'kind' : 'webfonts#webfont',
			...
			},
			{
				'kind' : 'webfonts#webfont',
				'family' : 'Ubuntu',
				'variants' : [ '300', '300italic', 'regular', 'italic', '500',
 ...
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 * use this file edcept in compliance with the License. You may obtain a copy of
 * the License at
 * 
 * http://www.apache.org/licenses/LICENSE-2.0
 * 
 * Unless required by applicable law or agreed to in writing, software
 * distributed under the License is distributed on an "AS IS" BASIS, WITHOUT
 * WARRANTIES OR CONDITIONS OF ANY KIND, either edpress or implied. See the
 * License for the specific language governing permissions and limitations under
 * the License. ==========================================================
 */
...
+function($) {
	...
	BFHCountries.prototype = {
		...
		addCountries : function() {
			...
			for (country in countries) {
				if (countries.hasOwnProperty(country)) {
					this.$element.append('<option value="' + country + '">'
		...
		addBootstrapCountries : function() {
			...
			if (this.options.blank === true) {
				$options
						.append('<li><a tabindex="-1" href="#" data-option=""></a></li>');
			}
			...
			for (country in countries) {
				if (countries.hasOwnProperty(country)) {
					if (this.options.flags === true) {
						$options
								.append('<li><a tabindex="-1" href="#" data-option="'
										+ country
										+ '"><i class="glyphicon bfh-flag-'
										+ country
										+ '"></i>'
										+ countries[country] + '</a></li>');
					} else {
						$options
								.append('<li><a tabindex="-1" href="#" data-option="'
										+ country
		...
		displayCountry : function() {
			...
			if (this.options.flags === true) {
				this.$element.html('<i class="glyphicon bfh-flag-' + value
						+ '"></i> ' + BFHCountriesList[value]);
			} else {
	...
	$.fn.bfhcountries = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhcountries', (data = new BFHCountries(this,
						options)));
			}
						...
						$(
								...
								.each(
										function() {
											...
											if ($countries
													.hasClass('bfh-selectbox')) {
												$countries
														.bfhselectbox($countries
																.data());
											}
											$countries.bfhcountries($countries
													.data());
										});
					});
...
+function($) {
	...
	BFHCurrencies.prototype = {
			...
			for (currency in currencies) {
				if (currencies.hasOwnProperty(currency)) {
					this.$element.append('<option value="' + currency + '">'
							+ currencies[currency].label + '</option>');
				}
			}
		...
		displayCurrency : function() {
			...
			if (this.options.flags === true) {
				...
				this.$element.html('<i class="glyphicon bfh-flag-' + flag
						+ '"></i> ' + BFHCurrenciesList[value].label);
			} else {
	...
	$.fn.bfhcurrencies = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhcurrencies', (data = new BFHCurrencies(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
								...
								.each(
										function() {
											...
											if ($currencies
													.hasClass('bfh-selectbox')) {
												$currencies
														.bfhselectbox($currencies
																.data());
											}
											$currencies
													.bfhcurrencies($currencies
															.data());
										});
					});
...
+function($) {
	...
	var toggle = '[data-toggle=bfh-datepicker]', BFHDatePicker = function(
			element, options) {
	...
	BFHDatePicker.prototype = {
		...
		setDate : function() {
			...
			if (date === '' || date === 'today' || date === undefined) {
				...
				if (date === 'today') {
					this.$element.val(formatDate(format, today.getMonth(),
							today.getFullYear(), today.getDate()));
				}
				...
				this.$element.data('month', Number(getDatePart(format, date,
						'm') - 1));
				this.$element.data('year',
						Number(getDatePart(format, date, 'y')));
			}
		},
		...
		setDateLimit : function(date, limitPrefix) {
			...
			if (date !== '') {
				...
				if (date === 'today') {
					...
					this.$element.data(limitPrefix + 'year', today
							.getFullYear());
				} else {
					this.$element.data(limitPrefix + 'day', Number(getDatePart(
							format, date, 'd')));
					this.$element.data(limitPrefix + 'month',
							Number(getDatePart(format, date, 'm') - 1));
					this.$element.data(limitPrefix + 'year',
							Number(getDatePart(format, date, 'y')));
				}
			} else {
		...
		initCalendar : function() {
			...
			if (this.options.icon !== '') {
				icon = '<span class="input-group-addon"><i class="'
						+ this.options.icon + '"></i></span>';
		...
		updateCalendarHeader : function($calendar, month, year) {
			...
			$calendar.find('table > thead > tr > th.month > span').text(
					BFHMonthsList[month]);
		...
		checkMinDate : function(day, month, year) {
			...
			if (lowerlimit === true) {
				...
				if ((day < lowerday && month === lowermonth && year === loweryear)
						|| (month < lowermonth && year === loweryear)
						|| (year < loweryear)) {
					return true;
				}
			}
		...
		checkMaxDate : function(day, month, year) {
			...
			if (higherlimit === true) {
				...
				if ((day > higherday && month === highermonth && year === higheryear)
		...
		select : function(e) {
			...
			$parent
					.val(formatDate($datePicker.options.format, month, year,
							day));
		...
		toggle : function(e) {
			...
			if ($parent.is('.disabled')
					|| $parent.attr('disabled') !== undefined) {
				return true;
			}
	...
	function getDatePart(format, date, part) {
		...
		partPositions = [ {
			'part' : 'm',
			'position' : format.indexOf('m')
		}, {
			'part' : 'y',
			'position' : format.indexOf('y')
		}, {
			'part' : 'd',
			'position' : format.indexOf('d')
		} ];
	...
	$.fn.bfhdatepicker = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhdatepicker', (data = new BFHDatePicker(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
...
+function($) {
	...
	BFHFonts.prototype = {
		...
		addFonts : function() {
			...
			for (font in fonts) {
				if (fonts.hasOwnProperty(font)) {
					this.$element.append('<option value="' + font + '">' + font
							+ '</option>');
				}
			}
		...
		addBootstrapFonts : function() {
			...
			for (font in fonts) {
				if (fonts.hasOwnProperty(font)) {
					$options
							.append('<li><a tabindex="-1" href="#" style=\'font-family: '
									+ fonts[font]
									+ '\' data-option="'
									+ font
									+ '">' + font + '</a></li>');
	...
	$(window).on(
			'load',
			function() {
				$('form select.bfh-fonts, span.bfh-fonts, div.bfh-fonts').each(
						function() {
							var $fonts;
...
+function($) {
		...
		addFontSizes : function() {
			...
			for (fontsize in fontsizes) {
				if (fontsizes.hasOwnProperty(fontsize)) {
					this.$element.append('<option value="' + fontsize + '">'
							+ fontsizes[fontsize] + '</option>');
				}
			}
	...
	$.fn.bfhfontsizes = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhfontsizes', (data = new BFHFontSizes(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
								...
								.each(
										function() {
											...
											if ($fontSizes
													.hasClass('bfh-selectbox')) {
												$fontSizes
														.bfhselectbox($fontSizes
																.data());
											}
											$fontSizes.bfhfontsizes($fontSizes
													.data());
										});
					});
...
+function($) {
	...
	BFHGoogleFonts.prototype = {
			...
			if (this.options.subset) {
				for (font in BFHGoogleFontsList.items) {
					if (BFHGoogleFontsList.items.hasOwnProperty(font)) {
						if ($.inArray(this.options.subset,
								BFHGoogleFontsList.items[font].subsets) >= 0) {
				...
				for (font in BFHGoogleFontsList.items) {
					if (BFHGoogleFontsList.items.hasOwnProperty(font)) {
						if ($.inArray(BFHGoogleFontsList.items[font].family,
								this.options.available) >= 0) {
							fonts[BFHGoogleFontsList.items[font].family] = {
								'info' : BFHGoogleFontsList.items[font],
								'index' : parseInt(font, 10)
							};
		...
		addBootstrapFonts : function() {
			...
			if (this.options.blank === true) {
				$options
						.append('<li><a tabindex="-1" href="#" data-option="" style="background-image: none;"></a></li>');
			}

			for (font in fonts) {
				if (fonts.hasOwnProperty(font)) {
					$options
							.append('<li><a tabindex="-1" href="#" style="background-position: 0 -'
									+ ((fonts[font].index * 30) - 2)
									+ 'px;" data-option="'
									+ fonts[font].info.family
									+ '">'
									+ fonts[font].info.family + '</a></li>');
				}
			}
	...
	$.fn.bfhgooglefonts = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhgooglefonts', (data = new BFHGoogleFonts(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
								...
								.each(
										function() {
											...
											if ($googleFonts
													.hasClass('bfh-selectbox')) {
												$googleFonts
														.bfhselectbox($googleFonts
																.data());
											}
											$googleFonts
													.bfhgooglefonts($googleFonts
															.data());
										});
					});
 ...
 * https://github.com/vlamanna/BootstrapFormHelpers
 * ========================================================== Copyright 2012
 * Vincent Lamanna Contribution 2013 Tomasz Kuter
 * 
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 * use this file except in compliance with the License. You may obtain a copy of
 * the License at
...
+function($) {
	...
	BFHLanguages.prototype = {
			...
			for (language in languages) {
				if (languages.hasOwnProperty(language)) {
					if (languages[language].hasOwnProperty('name')) {
						this.$element.append('<option value="' + language + '_'
								+ languages[language].country + '">'
								+ languages[language].name.toProperCase()
								+ ' ('
								+ BFHCountriesList[languages[language].country]
								+ ')</option>');
					} else {
						this.$element.append('<option value="' + language
								+ '">' + languages[language].toProperCase()
								+ '</option>');
					}
				}
			}
		...
		displayLanguage : function() {
			...
			if (value.indexOf('_') !== -1) {
				value = value.split('_');
				if (this.options.flags === true) {
					this.$element.html('<i class="glyphicon bfh-flag-'
							+ value[1] + '"></i> '
							+ BFHLanguagesList[value[0]].toProperCase());
				} else {
					this.$element.html(BFHLanguagesList[value[0]]
							.toProperCase()
							+ ' (' + BFHCountriesList[value[1]] + ')');
				}
			} else {
	...
	$.fn.bfhlanguages = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhlanguages', (data = new BFHLanguages(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
								...
								.each(
										function() {
											...
											if ($languages
													.hasClass('bfh-selectbox')) {
												$languages
														.bfhselectbox($languages
																.data());
											}
											$languages.bfhlanguages($languages
													.data());
										});
					});
...
+function($) {
	...
	BFHPhone.prototype = {
		...
		loadFormatter : function() {
			...
			formattedNumber = formatNumber(this.options.format, this.$element
					.val());
		...
		displayFormatter : function() {
			...
			formattedNumber = formatNumber(this.options.format,
					this.options.number);
		...
		change : function() {
			var $this, cursorPosition, cursorEnd;
	...
	function formatNumber(format, number) {
		var formattedNumber, indexFormat, indexNumber;
	...
	$(document)
			.on(
					'propertychange.bfhphone.data-api change.bfhphone.data-api input.bfhphone.data-api keyup.bfhphone.data-api',
					'.bfh-phone', BFHPhone.prototype.change);
...
+function($) {
	...
	var toggle = '[data-toggle=bfh-selectbox]', BFHSelectBox = function(
			element, options) {
	...
	BFHSelectBox.prototype = {
		...
		initSelectBox : function() {
			...
			options = '';
			this.$element.find('div.bfh-selectbox-option').each(
					function() {
						options = options
			...
			this.$element.html('<input type="hidden" name="'
					+ this.options.name + '" value="">'
					+ '<a class="bfh-selectbox-toggle ' + this.options.input
					+ '" role="button" data-toggle="bfh-selectbox" href="#">'
					+ '<span class="bfh-selectbox-option"></span>'
					+ '<span class="' + this.options.icon
					+ ' selectbox-caret"></span>' + '</a>'
			...
			this.$element
					...
					.on('mouseenter.bfhselectbox.data-api',
							'[role=option] > li > a',
							BFHSelectBox.prototype.mouseenter)
					.on('click.bfhselectbox.data-api',
							'[role=option] > li > a',
		...
		toggle : function(e) {
			...
			if (!isActive) {
				...
				$parent.toggleClass('open').trigger('shown.bfhselectbox').find(
						'[role=option] > li > [data-option="' + $parent.val()
								+ '"]').focus();
			}
		...
		filter : function() {
			...
			$items.hide().filter(
					function() {
						return ($(this).text().toUpperCase().indexOf(
								$this.val().toUpperCase()) !== -1);
					}).show();
		},
		...
		keydown : function(e) {
			...
			$('body')
					.off('mouseenter.bfh-selectbox.data-api',
							'[role=option] > li > a',
							BFHSelectBox.prototype.mouseenter);
			...
			$('body')
					.on('mouseenter.bfh-selectbox.data-api',
							'[role=option] > li > a',
							BFHSelectBox.prototype.mouseenter);
		},
...
+function($) {
			...
			for (state in BFHStatesList[country]) {
				if (BFHStatesList[country].hasOwnProperty(state)) {
					this.$element.append('<option value="'
							...
							+ BFHStatesList[country][state].name + '</option>');
				}
			}
	...
	$(window).on(
			'load',
			function() {
				$('form select.bfh-states, span.bfh-states, div.bfh-states')
						.each(function() {
							var $states;
...
!function($) {
	...
	var toggle = '[data-toggle=bfh-timepicker]', BFHTimePicker = function(
			element, options) {
	...
	BFHTimePicker.prototype = {
		...
		setTime : function() {
			...
			if (time === '' || time === 'now' || time === undefined) {
				...
				if (time === 'now') {
					this.$element.val(formatTime(today.getHours(), today
							.getMinutes()));
				}
				// remove to have show current time on server
				// this.$element.data('hour', today.getHours());
				// this.$element.data('minute', today.getMinutes());
				this.$element.data('hour', 0);
				this.$element.data('minute', 0);
			} else {
		...
		initPopover : function() {
			...
			this.$element
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							toggle, BFHTimePicker.prototype.toggle)
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							'.bfh-timepicker-popover > table .hour > .previous',
							BFHTimePicker.prototype.previousHour)
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							'.bfh-timepicker-popover > table .hour > .next',
							BFHTimePicker.prototype.nextHour)
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							'.bfh-timepicker-popover > table .minute > .previous',
							BFHTimePicker.prototype.previousMinute)
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							'.bfh-timepicker-popover > table .minute > .next',
							BFHTimePicker.prototype.nextMinute)
					.on(
							'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
							'.bfh-timepicker-popover > table', function() {
								return false;
							});
	...
	$.fn.bfhtimepicker = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhtimepicker', (data = new BFHTimePicker(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
	...
	$.valHooks.div = {
		...
		set : function(el, val) {
			if ($(el).hasClass('bfh-timepicker')) {
				$(el).find('.bfh-timepicker-toggle > input[type="text"]').val(
						val);
			} else if (origHook) {
				return origHook.set(el, val);
			}
...
+function($) {
	...
	$.fn.bfhtimezones = function(option) {
		return this.each(function() {
			...
			if (!data) {
				$this.data('bfhtimezones', (data = new BFHTimezones(this,
						options)));
			}
			if (typeof option === 'string') {
				data[option].call($this);
