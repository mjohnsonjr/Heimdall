...
<body>
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index"> <img alt="Timely"
				src="<c:url value="/resources/img/TimelyFullLogoSmall.png"/>"
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse pull-right">
			<ul class="nav navbar-nav">
				...
				<li><a href="#"><img alt="Profile Pic"
						src="<c:url value="/resources/img/timelyManSmall.png"/>"
						class="img-rounded pull-right" style="width: 15%;"></a></li>
				<li id="topbarOptions"><a href="content/options"><strong>${username}
					</strong><span class="glyphicon glyphicon-cog"></span></a></li>
		...
		<div class="col-xs-1 col-sm-2 col-md-2 col-lg-2 sidebar-offcanvas"
			...
			<div class="well sidebar-nav">
				<ul class="nav" id="sidebarList">
					...
					<li id="sidebarCalendar"><a href="content/calendar">Calendar</a></li>
					<li id="sidebarShiftScheduler"><a
						href="content/shiftScheduler">Shift Scheduler</a></li>
					<li id="sidebarShiftTrader"><a href="content/shiftTrader">Shift
							Trader</a></li>
					<li id="sidebarTimeKeeper"><a href="content/timeKeeper">Time
							Keeper</a></li>
				</ul>
			</div>
		</div>
