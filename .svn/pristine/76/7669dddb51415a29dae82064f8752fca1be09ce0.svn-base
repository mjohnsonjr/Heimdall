    	...
    	<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="well">
						<p>
							Currently we are not looking to add any member to our team.  Check back every so often, we will be expanding soon enough. 
						</p>
					</div>
				</div>
			</div>
